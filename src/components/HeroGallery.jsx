...
const HeroGallery = () => {
  ...
  return (
    <div
      ...
      } heroGaller w-full flex flex-col pl-4 sm:pl-10`}
    >
      <h1 className="text-3xl sm:text-4xl font-bold mb-4">Today's Hot Deals</h1>
      ...
      <div className="container mx-auto px-2 sm:px-5 py-2 lg:px-32 lg:pt-8">
