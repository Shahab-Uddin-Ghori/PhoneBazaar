...
import { ThemeContext } from "./ModeThemeContext"; // Import ThemeContext for theme management
import { useNavigate } from "react-router-dom"; // Import useNavigate for navigation

function PageNotFound() {
  const [theme] = useContext(ThemeContext); // Fetch the current theme from context
  ...
  return (
    <div
      className={`h-screen w-screen flex items-center ${
        theme === "light" // Conditional class assignment based on theme
